...
* @description base64ToBlob - Mobile
* @multilayer false
* @returns {ObjectType.STRING}
*/
this.cronapi.myfunctions.base64ToBlob = function(/** @type {ObjectType.STRING} @description data: data */
data, /** @type {ObjectType.STRING} @description mimeType: mimeType */ mimeType) {
...
*/
this.cronapi.myfunctions.convertFileToBase64 = function(/** @type {ObjectType.OBJECT} @description id: id do
componente @blockType ids_from_screen*/ id, /** @type {ObjectType.STATEMENTSENDER} @description Retorno da
função */ retorno) {
  ...
  */
  this.cronapi.myfunctions.downloadFile = function(/** @type {ObjectType.STRING} @description blob: blob para
  download */ blob, /** @type {ObjectType.STRING} @description filename: nome do arquivo */ filename) {
  try {
  ...
  alert("Não foi possível realizar o download do arquivo");
    ...
    * @returns {ObjectType.STRING}
    */
    this.cronapi.myfunctions.returnUrlToBlob = function(/** @type {ObjectType.STRING} @description blob: blob */
    blob) {
    try {
    var finalURL = URL.createObjectURL(blob);
    return finalURL;
